                                    ...
                                    <div className="mt-6 flex justify-end gap-3">
                                      ...
                                      <AlertDialog.Action asChild>
                                        <button
                                          ...
                                          className="rounded-full bg-destructive px-4 py-2 text-sm font-semibold text-destructive-foreground shadow-lg shadow-red-300/50 hover:bg-red-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-600/60 disabled:opacity-60"
